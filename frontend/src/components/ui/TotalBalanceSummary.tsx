  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      <div className="flex flex-col lg:flex-row lg:gap-4 p-4 flex-1 rounded-xl bg-slate-600 shadow-lg">
        ...
        <span className="text-3xl md:text-4xl lg:text-5xl lg:flex-1 lg:text-center font-semibold text-neutral-50 tracking-tight">{balances.hasToPay}</span>
      </div>
      {/* You Are Owed */}
      <div className="flex flex-col lg:flex-row lg:gap-4 p-4 flex-1 rounded-xl bg-gray-100 shadow">
        ...
        <span className="text-3xl md:text-4xl lg:text-5xl lg:flex-1 lg:text-center font-semibold text-gray-900 tracking-tight">{balances.getsBack}</span>
      </div>
    </div>
    );
//     return (
